...
export const QuickActionModal: React.FC<QuickActionModalProps> = ({
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-md bg-surface border border-app rounded-3xl shadow-2xl text-app max-h-[90vh] sm:max-h-[92vh] flex flex-col overflow-hidden animate-in zoom-in-95 duration-200 cursor-default"
        role="dialog"
